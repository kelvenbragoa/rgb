    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{__('message.delete_message')}}"{{$item->tallyclerk->name}}"</h5>
        ...
        <div class="modal-footer">
            <form method="POST" action="{{ route('manager-tallyclerkship.destroy',$item->id)}}">
                @csrf
                @method('DELETE')

...
<div class="container-fluid p-0">
    ...
    <a href="{{URL::to('/agent-ship/'.$basement->ship_id)}}" class="btn btn-pill btn-primary mb-3"><i class="far fa-arrow-left"></i>{{__('text.back')}}</a>
    <a href="{{URL::to('/agent-basement-report/'.$basement->id)}}" target="_blank" class="btn btn-pill btn-primary mb-3"><i class="far fa-file"></i>{{__('text.download')}}</a>
    <div class="row">
        <div class="col-md-12">
            <div class="row">

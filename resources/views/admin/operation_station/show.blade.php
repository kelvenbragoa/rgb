                ...
                <div class="col-xl-12 col-xxl-12 d-flex">
                    <div class="w-100">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <p>{{__('text.name')}}: {{$operation_station->name}}</p>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h3 class="mt-1 mb-3">{{$operation_station->ship->count()}}</h3>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h3 class="mt-1 mb-3">{{$operation_station->tallybook->sum('load')}} KG</h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table display" >
                                            ...
                                            <tbody>
                                                @foreach ($operation_station->ship as $item)
                                                    <tr>
                                                        {{-- <td>{{$item->id}}</td> --}}
                                                        <td>{{$item->name}}</td>

                    ...
                    <table id="myTable" class="table display" >
                        <thead>
                            <tr>
                                ...
                                <th style="width:20%">{{__('text.email')}}</th>
                                <th style="width:20%">{{__('text.mobile')}}</th>
                                <th style="width:25%">{{__('text.operation_station')}}</th>
                            ...
                            @foreach ($tallyclerks as $item)
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="{{URL::to('/tallyclerk/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>

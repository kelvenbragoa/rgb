                ...
                <div class="col-xl-12 col-xxl-12 d-flex">
                    <div class="w-100">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <p>{{__('text.name')}}: {{$type_merchandises->name}}</p>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h3 class="mt-1 mb-3">{{$type_merchandises->ship->count()}}</h3>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h3 class="mt-1 mb-3">{{$type_merchandises->tallybook->sum('load')}} KG</h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table display" >
                                            ...
                                            <tbody>
                                                @foreach ($type_merchandises->ship as $item)
                                                    <tr>
                                                        {{-- <td>{{$item->id}}</td> --}}
                                                        <td>{{$item->name}}</td>

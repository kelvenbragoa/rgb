        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{{__('text.shift')}}</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" id="form" action="{{route('shift.store')}}">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="time" class="form-control" name="start_time" id="source" placeholder="{{__('text.start_time')}}" value="{{ old('start_time') }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="time" class="form-control" name="end_time" id="end_time" placeholder="{{__('text.end_time')}}" value="{{ old('end_time') }}" required>
                            </div>

                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                        @if ($ship->status==0)
                                            <a href="" data-toggle="modal" data-target="#exampleCloseOperation" class="btn btn-pill btn-primary mb-3"><i class="far fa-file"></i>{{__('text.close_operation')}}</a>
                                        @else
                                            <a href="{{URL::to('/closeoperation/'.$ship->id)}}" class="btn btn-pill btn-primary mb-3"><i class="far fa-eye"></i>{{__('text.result_operation')}}</a>
                                        @endif 
                                        @include('admin.ship.modalclose')
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    @include('admin.ship.modal.addshift')
                                    @endif
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable2" class="table display" >
                                            ...
                                            <tbody>
                                                @foreach ($ship->shifts as $item)
                                                    <tr>
                                                       ...
                                                       <td class="table-action">
                                                        ...
                                                        @endif
                                                            ...
                                                            <a href="{{URL::to('shiftship/'.$item->id.'/tallyclerkship')}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>
                                                            @if ($ship->status == 0)
                                                    ...
                                                    @include('admin.ship.modal.editshift')
                                                    @include('admin.ship.modal.deleteshift')
                                        ...
                                        @include('admin.ship.modal.addbasement')
                                        @endif
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                @foreach ($ship->basements as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{$item->tallybook->sum('load')}} KG</td>
                                                       <td class="table-action">
                                                        <a href="{{URL::to('/basement/'.$item->id)}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>
                                                    ...
                                                    @include('admin.ship.modal.deletebasement')
                                                    @include('admin.ship.modal.editbasement')
                                                    {{-- @include('manager.meeting.modal.edittask')
                                                    @include('manager.meeting.modal.copytask')
                                                    @include('manager.meeting.modal.deletetask') --}}
                                                @endforeach
                                        ...
                                        @include('admin.ship.modal.adddestination')
                                        @endif
                                                ...
                                                <tbody>
                                                    @foreach ($ship->destinations as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{$item->tallybook->sum('load')}} KG</td>
                                                           <td class="table-action">
                                                            <a href="{{URL::to('/destination/'.$item->id)}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>
                                                                {{-- <a href="" data-toggle="modal" data-target="#exampleModalCenterEditTask{{$item->id}}" title="{{__('text.edit')}}"><i class="align-middle" data-feather="edit-2"></i></a>
                                                                <a href="" data-toggle="modal" data-target="#exampleModalCenterCopyTask{{$item->id}}" title="{{__('text.copy_task')}}"><i class="align-middle" data-feather="copy"></i></a> 
                                                                <a href="{{URL::to('manager-shiftship/'.$item->id.'/manager-tallyclerkship')}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>--}}
                                                                @if ($ship->status == 0)
                                                        ...
                                                        @include('admin.ship.modal.deletedestination')
                                                        @include('admin.ship.modal.editdestination')
                                                        {{-- @include('manager.meeting.modal.edittask')
                                                        @include('manager.meeting.modal.copytask')
                                                        @include('manager.meeting.modal.deletetask') --}}
                                                    @endforeach

...
<div class="container-fluid p-0">
    ...
    <a href="{{route('customer-ship.index')}}" class="btn btn-pill btn-primary mb-3"><i class="far fa-arrow-left"></i>{{__('text.back')}}</a>
    ...
    @endif
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @if ($ship->status==1)
                        <a href="{{URL::to('/customer-closeoperation/'.$ship->id)}}" class="btn btn-pill btn-primary mb-3"><i class="far fa-eye"></i>{{__('text.result_operation')}}</a>
                    @endif
                                                ...
                                                @foreach ($ship->shifts as $item)
                                                    <tr>
                                                       ...
                                                       <td class="table-action">
                                                            ...
                                                            <a href="{{URL::to('customer-shiftship/'.$item->id.'/customer-tallyclerkship')}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>
                                            ...
                                            <tbody>
                                                @foreach ($ship->basements as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{$item->tallybook->sum('load')}} KG</td>
                                                       <td class="table-action">
                                                        <a href="{{URL::to('/customer-basement/'.$item->id)}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>

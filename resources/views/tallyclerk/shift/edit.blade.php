                    ...
                    <form action="{{ route('manager-ship.update', $ship->id)}}" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <select type="time" class="form-control" name="customer_id" id="customer_id" placeholder="{{__('text.customer')}}" required>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="agent" id="agent" placeholder="{{__('text.agent')}}" value="{{ $ship->agent }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="type_merchandise" id="type_merchandise" placeholder="{{__('text.type_merchandise')}}" value="{{ $ship->type_merchandise }}" >
                            </div>

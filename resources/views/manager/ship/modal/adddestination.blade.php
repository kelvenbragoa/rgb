<div class="modal" id="exampleAddDestination" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method="POST" action="{{route('manager-destination.store')}}">
          @csrf
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="{{__('text.destination')}}" required>
          </div>

...
<div class="container-fluid p-0">
    ...
    <a href="{{URL::to('/manager-shift-report/'.$shiftship->id)}}" target="_blank" class="btn btn-pill btn-primary mb-3"><i class="far fa-file"></i>{{__('text.download')}}</a>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <h3 class="mt-1 mb-3">{{$shiftship->equipments->count()}}</h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable2" class="table display" >
                                            ...
                                            <tbody>
                                                @foreach ($shiftship->tallyclerkship as $item)
                                                    <tr>
                                                       ...
                                                       <td class="table-action">
                                                            ...
                                                            <a href="" data-toggle="modal" data-target="#exampleModalCenterCopyTask{{$item->id}}" title="{{__('text.copy_task')}}"><i class="align-middle" data-feather="copy"></i></a> --}}
                                                             <a href="{{URL::to('manager-tallyclerkshiftship/'.$item->id.'/manager-ship/'.$item->ship->id)}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>
                                                             @if ($shiftship->ship->status == 0)
                                                    ...
                                                    @include('manager.ship.tallyclerkshift.modal.deletetallyclerk')
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            @if ($shiftship->status == 1)
                                                ...
                                                @include('manager.ship.tallyclerkshift.modal.addstop')
                                            @endif
                                            @endif
                                                ...
                                                <table id="myTable3" class="table display" >
                                                    ...
                                                    <tbody>
                                                        @foreach ($stops as $item)
                                                            ...
                                                            @include('manager.ship.tallyclerkshift.modal.editstop')

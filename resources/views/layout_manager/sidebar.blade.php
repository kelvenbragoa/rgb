<nav id="sidebar" class="sidebar" >
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('manager-tallyclerk.index')}}">
                <i class="align-middle" data-feather="users"></i> <span class="align-middle">{{__('text.tallyclerk')}}</span>
                </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('manager-customer.index')}}">
                <i class="align-middle" data-feather="users"></i> <span class="align-middle">{{__('text.customer')}}</span>
                </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('manager-agent.index')}}">
                <i class="align-middle" data-feather="users"></i> <span class="align-middle">{{__('text.agent')}}</span>
                </a>
            </li>

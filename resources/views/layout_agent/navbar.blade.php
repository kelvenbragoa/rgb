            ...
            <ul class="navbar-nav navbar-align">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0" aria-labelledby="alertsDropdown">
                        <div class="dropdown-menu-header">
                            <a href="{{route('agent-notification.index')}}" class="text-muted">{{count(Auth::user()->unreadNotifications)}} {{__('text.notification')}}</a>
                        </div>
                        <div class="list-group">
                        ...
                        <div class="dropdown-menu-footer">
                            <a href="{{route('agent-notification.index')}}" class="text-muted">{{__('text.show_notification')}}</a> <br>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('agent-configuration.index')}}"><i class="align-middle mr-1" data-feather="settings"></i>{{__('text.config')}}</a>

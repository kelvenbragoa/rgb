...
<div class="container-fluid p-0">
    ...
    <a href="{{route('agent-ship.index')}}" class="btn btn-pill btn-primary mb-3"><i class="far fa-arrow-left"></i>{{__('text.back')}}</a>
    <a href="{{URL::to('/agent-general-report/'.$ship->id)}}" target="_blank" class="btn btn-pill btn-primary mb-3"><i class="far fa-file"></i>{{__('text.download')}}</a>
    ...
    @endif
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    @if ($ship->status==1)
                        <a href="{{URL::to('/agent-closeoperation/'.$ship->id)}}" class="btn btn-pill btn-primary mb-3"><i class="far fa-eye"></i>{{__('text.result_operation')}}</a>
                    @endif
                                                ...
                                                @foreach ($ship->shifts as $item)
                                                    <tr>
                                                       ...
                                                       <td class="table-action">
                                                            ...
                                                            <a href="{{URL::to('agent-shiftship/'.$item->id.'/agent-tallyclerkship')}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>
                                            ...
                                            <tbody>
                                                @foreach ($ship->basements as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{$item->tallybook->sum('load')}} KG</td>
                                                       <td class="table-action">
                                                        <a href="{{URL::to('/agent-basement/'.$item->id)}}"  title="{{__('text.show')}}"><i class="align-middle" data-feather="eye"></i></a>

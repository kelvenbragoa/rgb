        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{{__('text.customer')}}</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" id="form" action="{{route('customer.store')}}">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="address" id="address" placeholder="{{__('text.address')}}" value="{{ old('address') }}" required>
                            </div>
